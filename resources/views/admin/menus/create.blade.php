...
<div class="container mt-4" style="max-width: 550px;">
    ...
    <form action="{{ route('admin.menus.store') }}" method="POST">
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" name="actif" class="form-check-input" id="actif" {{ old('actif') ? 'checked' : '' }}>
            <label class="form-check-label" for="actif">Menu actif (visible sur la page d'accueil)</label>
        </div>
        <button type="submit" class="btn btn-primary w-100">Créer le menu</button>
